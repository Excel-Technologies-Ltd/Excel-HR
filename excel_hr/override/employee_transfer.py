...
def update_employee_work_history(employee, details, date=None, cancel=False):
	...
	for item in details:
		...
		if item.fieldname == "employment_type":
			setattr(employee, "custom_employment_sub_type", "")
		if item.fieldname == "excel_parent_department":
			setattr(employee, "excel_hr_section", "")
			setattr(employee, "excel_hr_sub_section", "")
		if item.fieldname == "excel_hr_section":
			setattr(employee, "excel_hr_sub_section", "")
